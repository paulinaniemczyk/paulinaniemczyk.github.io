...
/*  Napisz funkcję, która przyjmie jeden parametr - tablicę z id użytkowników.
Funkcja wyświetli następujące informacje dla każdego użytkownika z id z tablicy

"Użytkownik o id x ma na imię xxx i mieszka w mieście xxx" */

function printUsersInfo(idArr) {
    console.log(idArr);
